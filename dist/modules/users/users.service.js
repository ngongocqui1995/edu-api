...
let UsersService = class UsersService extends crud_typeorm_1.TypeOrmCrudService {
    ...
    async validate(dto, id) {
        await this.baseService.Unique(enum_1.ENUM_FIELD.EMAIL, user_entity_1.User, {
            email: dto.email,
            ...(id && { id: (0, typeorm_1.Not)(id) }),
        });
        await this.baseService.Unique(enum_1.ENUM_FIELD.PHONE, user_entity_1.User, {
            phone: dto.phone,
            ...(id && { id: (0, typeorm_1.Not)(id) }),
        });
    }
    ...
    async changePassword(req, changePasswordDTO) {
        ...
        const [err] = await (0, await_to_js_1.default)(this.repo.update(user.id, { password: changePasswordDTO.new_password }));
        if (err)
            this.baseService.ThrowError(err.message);
        return {
            status: common_1.HttpStatus.OK,
...
exports.UsersService = UsersService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(user_entity_1.User, enum_1.DB_NAME.DB_POSTGRES)),
    __param(1, (0, typeorm_2.InjectDataSource)(enum_1.DB_NAME.DB_POSTGRES)),
